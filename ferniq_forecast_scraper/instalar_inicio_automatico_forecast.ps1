...
$taskName = "FerniqTelegramForecastBot"
$repoDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$launcherPath = Join-Path $repoDir "arrancar_bot_automatico_forecast.ps1"
...
Register-ScheduledTask `
    ...
    -Trigger $trigger `
    -Settings $settings `
    -Description "Arranca automaticamente el bot de Telegram de Forecast de Ferniq al iniciar sesion." `
    -Force | Out-Null
